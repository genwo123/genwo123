...
### 연구 및 도전
- [코딩 교육과 게임 제작의 연계성](../docs/pdf/코딩교육과게임제작의연계성_김건우.pdf) - GSKO 2023 논문 공모전
- 프로그래머스 코딩 테스트 스터디 운영 (1~2LV)

---

### 코딩 테스트 학습 자료
- [코딩테스트 정리 (노션 링크)](https://www.notion.so/woogun/737b204be23041fc9bf6b596cd76a131?v=5060755523c6476d80139b5255209209)
  - 알고리즘 문제 풀이 및 복습을 위한 정리
  - 대표적인 문제 풀이 및 해결 전략 정리
  - 다양한 언어(C++, Python) 기반의 코드 작성 실습
